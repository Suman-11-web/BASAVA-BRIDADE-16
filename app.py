...
def index():
    ...
    # Fetch events to display dynamically on the homepage
    events = conn.execute("SELECT * FROM events").fetchall()
    conn.close()
    return render_template('index.html', president=president, secretary=secretary, treasurer=treasurer, events=events)
